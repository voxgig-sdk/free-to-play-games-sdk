...
// FreeToPlayGames SDK paging feature
...
class FreeToPlayGamesPagingFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _is_list(FreeToPlayGamesContext $ctx): bool
    {
