...
// FreeToPlayGames SDK metrics feature
...
class FreeToPlayGamesMetricsFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _record(FreeToPlayGamesContext $ctx, bool $ok): void
    {
