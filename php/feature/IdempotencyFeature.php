...
// FreeToPlayGames SDK idempotency feature
...
class FreeToPlayGamesIdempotencyFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _mutating(FreeToPlayGamesContext $ctx): bool
    {
