...
// FreeToPlayGames SDK rbac feature
...
class FreeToPlayGamesRbacFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _required(FreeToPlayGamesContext $ctx): ?string
    {
    ...
    private function _reject(FreeToPlayGamesContext $ctx, string $required): void
    {
    ...
    private function _track(FreeToPlayGamesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
