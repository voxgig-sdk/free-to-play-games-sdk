...
// FreeToPlayGames SDK cache feature
...
class FreeToPlayGamesCacheFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _through(FreeToPlayGamesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
