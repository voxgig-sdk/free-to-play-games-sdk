...
// FreeToPlayGames SDK proxy feature
...
class FreeToPlayGamesProxyFeature extends FreeToPlayGamesBaseFeature
{
    ...
    public function init(FreeToPlayGamesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeToPlayGamesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
