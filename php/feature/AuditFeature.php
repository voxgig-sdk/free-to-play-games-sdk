...
// FreeToPlayGames SDK audit feature
...
class FreeToPlayGamesAuditFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _emit(FreeToPlayGamesContext $ctx, string $outcome): void
    {
