...
// FreeToPlayGames SDK ratelimit feature
...
class FreeToPlayGamesRatelimitFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _acquire(FreeToPlayGamesContext $ctx): void
    {
    ...
    private function _track(FreeToPlayGamesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
