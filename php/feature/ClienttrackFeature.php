...
// FreeToPlayGames SDK clienttrack feature
...
class FreeToPlayGamesClienttrackFeature extends FreeToPlayGamesBaseFeature
{
    ...
    public function PostConstruct(FreeToPlayGamesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeToPlayGames-SDK';
