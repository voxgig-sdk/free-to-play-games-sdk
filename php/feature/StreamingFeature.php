...
// FreeToPlayGames SDK streaming feature
...
class FreeToPlayGamesStreamingFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _iterate(FreeToPlayGamesResult $result): \Generator
    {
    ...
    private function _streamable(FreeToPlayGamesContext $ctx): bool
    {
