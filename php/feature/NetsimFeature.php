...
// FreeToPlayGames SDK netsim feature
...
class FreeToPlayGamesNetsimFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _simulate(FreeToPlayGamesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeToPlayGamesContext $ctx, array $applied): void
    {
        $client = $this->client;
