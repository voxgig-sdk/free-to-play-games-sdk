...
// FreeToPlayGames SDK debug feature
...
class FreeToPlayGamesDebugFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _finish(FreeToPlayGamesContext $ctx, bool $ok): void
    {
