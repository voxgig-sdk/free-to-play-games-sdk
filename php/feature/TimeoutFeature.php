...
// FreeToPlayGames SDK timeout feature
...
class FreeToPlayGamesTimeoutFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _with_timeout(FreeToPlayGamesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeToPlayGamesContext $_ctx, float $ms): void
    {
        $client = $this->client;
