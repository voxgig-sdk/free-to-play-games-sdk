# FreeToPlayGames PHP SDK



The PHP SDK for the FreeToPlayGames API — an entity-oriented client using PHP conventions.
...
```php
$client = FreeToPlayGamesSDK::test($testopts, $sdkopts);
```
...
| `minimum_system_requirements` | `array` | Minimum system requirements for PC games |
...
```
php/
├── freetoplaygames_sdk.php          -- Main SDK class
...
The main class (`freetoplaygames_sdk.php`) exports the SDK class
