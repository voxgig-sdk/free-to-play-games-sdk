...
// FreeToPlayGames SDK utility: graphql
//
...
class FreeToPlayGamesGraphql
{
    ...
    // equivalent.
    public static function body(FreeToPlayGamesContext $ctx): mixed
    {
    ...
    public static function errors(FreeToPlayGamesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
