...
// FreeToPlayGames SDK pipeline test
//
...
{
    private static function utility(): FreeToPlayGamesUtility
    {
        return new FreeToPlayGamesUtility();
    }
    ...
    private static function ctx(array $over = []): FreeToPlayGamesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new FreeToPlayGamesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new FreeToPlayGamesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof FreeToPlayGamesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new FreeToPlayGamesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = FreeToPlayGamesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new FreeToPlayGamesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = FreeToPlayGamesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new FreeToPlayGamesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = FreeToPlayGamesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeToPlayGamesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = FreeToPlayGamesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new FreeToPlayGamesResponse([]),
            'result' => new FreeToPlayGamesResult([]),
        ]);
        [, $err] = FreeToPlayGamesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new FreeToPlayGamesSpec([]),
            'response' => null,
            'result' => new FreeToPlayGamesResult([]),
        ]);
        [, $err] = FreeToPlayGamesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new FreeToPlayGamesSpec(['step' => 's']),
            'response' => new FreeToPlayGamesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new FreeToPlayGamesResult([]),
        ]);
        [, $err] = FreeToPlayGamesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeToPlayGamesSpec(['step' => 's']),
            'response' => new FreeToPlayGamesResponse(self::resp(200, ['v' => 1])),
            'result' => new FreeToPlayGamesResult([]),
        ]);
        [, $err] = FreeToPlayGamesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new FreeToPlayGamesSpec(['step' => 's']),
            'response' => new FreeToPlayGamesResponse(self::resp(200, ['v' => 2])),
            'result' => new FreeToPlayGamesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        FreeToPlayGamesMakeResponse::call($ctx);
    ...
    {
        $preset = new FreeToPlayGamesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new FreeToPlayGamesSpec([]),
            'response' => new FreeToPlayGamesResponse([]),
            'result' => new FreeToPlayGamesResult([]),
        ...
        [$got, $err] = FreeToPlayGamesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new FreeToPlayGamesResult([])]);
        [, $err] = FreeToPlayGamesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new FreeToPlayGamesSpec([]), 'result' => null]);
        [, $err] = FreeToPlayGamesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeToPlayGamesSpec(['step' => 's']),
            'result' => new FreeToPlayGamesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new FreeToPlayGamesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeToPlayGamesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new FreeToPlayGamesSpec(['step' => 's']),
            'result' => new FreeToPlayGamesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new FreeToPlayGamesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = FreeToPlayGamesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new FreeToPlayGamesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new FreeToPlayGamesSpec([]),
            'result' => new FreeToPlayGamesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = FreeToPlayGamesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeToPlayGamesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new FreeToPlayGamesError('boom', 'boom');
        $utility->fetcher = function (FreeToPlayGamesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeToPlayGamesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = FreeToPlayGamesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (FreeToPlayGamesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = FreeToPlayGamesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(FreeToPlayGamesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        FreeToPlayGamesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (FreeToPlayGamesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new FreeToPlayGamesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = FreeToPlayGamesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new FreeToPlayGamesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new FreeToPlayGamesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = FreeToPlayGamesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = FreeToPlayGamesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = FreeToPlayGamesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new FreeToPlayGamesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, FreeToPlayGamesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new FreeToPlayGamesResult(['ok' => false])]);
        $this->expectException(FreeToPlayGamesError::class);
        FreeToPlayGamesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new FreeToPlayGamesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', FreeToPlayGamesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        FreeToPlayGamesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new FreeToPlayGamesBaseFeature();
        $b = new FreeToPlayGamesBaseFeature();
        FreeToPlayGamesFeatureAdd::call($ctx, $a);
        FreeToPlayGamesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): FreeToPlayGamesBaseFeature
    {
        $f = new FreeToPlayGamesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        FreeToPlayGamesFeatureAdd::call($ctx, self::named_feature('a'));
        FreeToPlayGamesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        FreeToPlayGamesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        FreeToPlayGamesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        FreeToPlayGamesFeatureAdd::call($ctx, $replace);
        ...
        FreeToPlayGamesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): FreeToPlayGamesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new FreeToPlayGamesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = FreeToPlayGamesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        FreeToPlayGamesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new FreeToPlayGamesResponse(['headers' => null]),
            'result' => new FreeToPlayGamesResult([]),
        ]);
        FreeToPlayGamesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        FreeToPlayGamesResultBody::call($ctx);
