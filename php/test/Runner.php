...
class FreeToPlayGamesTestRunner
{
    ...
    {
        $live = self::getenv('FREE_TO_PLAY_GAMES_TEST_LIVE');
        $override = self::getenv('FREE_TO_PLAY_GAMES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FREE_TO_PLAY_GAMES_TEST_EXPLAIN');
...
class_alias('FreeToPlayGamesTestRunner', 'Runner');
class_alias('FreeToPlayGamesHelpers', 'Helpers');
