...
// FreeToPlayGames SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeToPlayGamesSDK::test)
...
{
    private const SDK_CLASS = 'FreeToPlayGamesSDK';
    ...
    private const SDK_BASE = 'freetoplaygames_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../freetoplaygames_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
