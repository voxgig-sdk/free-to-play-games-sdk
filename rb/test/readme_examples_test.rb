...
#      offline in seeded test mode (FreeToPlayGamesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FreeToPlayGames_sdk.rb")
  SDK_CLASS = "FreeToPlayGamesSDK"
