# FreeToPlayGames SDK Game entity
...
class GameEntity
  ...
  def data_set(args)
    if args
      @_data = FreeToPlayGamesHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = FreeToPlayGamesHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Game>, Array] the matching Game items; raises FreeToPlayGamesError on failure
