# FreeToPlayGames Ruby SDK



The Ruby SDK for the FreeToPlayGames API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `FreeToPlayGamesError` (a `StandardError` subclass), so wrap
...
```
rb/
├── FreeToPlayGames_sdk.rb       -- Main SDK module
...
The main module (`FreeToPlayGames_sdk`) exports the SDK class
