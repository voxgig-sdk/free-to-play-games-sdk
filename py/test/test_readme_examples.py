# FreeToPlayGames SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeToPlayGamesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeToPlayGamesSDK(...) and FreeToPlayGamesSDK.test(...) become
#      FreeToPlayGamesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freetoplaygames_sdk"
_SDK_CLASS = "FreeToPlayGamesSDK"
