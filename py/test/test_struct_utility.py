...
from freetoplaygames_sdk.utility.voxgig_struct.voxgig_struct import (
...
class TestStructUtility(unittest.TestCase):
    ...
    def test_minor_joinurl(self):
        from freetoplaygames_sdk.utility.voxgig_struct.voxgig_struct import join as struct_join
