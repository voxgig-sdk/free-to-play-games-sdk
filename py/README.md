# FreeToPlayGames Python SDK



The Python SDK for the FreeToPlayGames API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/free-to-play-games-sdk/releases)) or
...
```
py/
├── freetoplaygames_sdk.py         -- Main SDK module
