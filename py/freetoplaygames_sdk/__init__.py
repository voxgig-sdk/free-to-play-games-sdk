...
from freetoplaygames_sdk.utility import register

# Load features
from freetoplaygames_sdk.feature.base_feature import FreeToPlayGamesBaseFeature
from freetoplaygames_sdk.features import _has_feature, _make_feature
...
class FreeToPlayGamesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreeToPlayGamesUtility()
    ...
    def get_utility(self):
        return FreeToPlayGamesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeToPlayGamesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Game(self, data=None) -> "GameEntity":
        ...
        from freetoplaygames_sdk.entity.game_entity import GameEntity
        return GameEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FreeToPlayGamesSDK":
        if sdkopts is None:
            sdkopts = {}
