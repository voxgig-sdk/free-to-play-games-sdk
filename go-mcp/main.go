// Command FreeToPlayGames-mcp is an MCP server exposing the FreeToPlayGames
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FreeToPlayGames_list  — list records of an entity
//	FreeToPlayGames_load  — load a single record of an entity
//
