...
func registerTools(server *mcp.Server, client *sdk.FreeToPlayGamesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-to-play-games_list",
		Description: "List records from FreeToPlayGames. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-to-play-games_load",
		Description: "Load a single record from FreeToPlayGames. " +
...
func runOp(client *sdk.FreeToPlayGamesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeToPlayGamesSDK, name string) (sdk.FreeToPlayGamesEntity, error) {
