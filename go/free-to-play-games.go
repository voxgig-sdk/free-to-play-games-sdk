...
// instead of `sdk.NewFreeToPlayGamesSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *FreeToPlayGamesSDK  { return NewFreeToPlayGamesSDK(nil) }
func Test() *FreeToPlayGamesSDK { return TestSDK(nil, nil) }
