# FreeToPlayGames Golang SDK Reference

Complete API reference for the FreeToPlayGames Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FreeToPlayGamesSDK`
...
#### `Game(data map[string]any) FreeToPlayGamesEntity`
...
| `minimum_system_requirements` | `map[string]any` | No | Minimum system requirements for PC games |
