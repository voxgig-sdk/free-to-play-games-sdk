...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-to-play-games` | `npm install @voxgig-sdk/free-to-play-games` |
| Python | `voxgig-sdk-free-to-play-games` | `pip install voxgig-sdk-free-to-play-games` |
| PHP | `voxgig-sdk/free-to-play-games` | `composer require voxgig-sdk/free-to-play-games` |
| Golang | `github.com/voxgig-sdk/free-to-play-games-sdk/go` | `go get github.com/voxgig-sdk/free-to-play-games-sdk/go` |
| Ruby | `voxgig-sdk-free-to-play-games` | `gem install voxgig-sdk-free-to-play-games` |
| Lua | `voxgig-sdk-free-to-play-games` | `luarocks install voxgig-sdk-free-to-play-games` |
