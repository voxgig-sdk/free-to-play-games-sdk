...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/free-to-play-games-sdk/releases)),
...
| `minimum_system_requirements` | `table` | Minimum system requirements for PC games |
...
| `screenshots` | `table` | Array of screenshot images |
...
```
lua/
├── free-to-play-games_sdk.lua    -- Main SDK module
...
The main module (`free-to-play-games_sdk`) exports the SDK constructor
