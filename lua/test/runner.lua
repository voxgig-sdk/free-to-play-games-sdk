...
function runner.env_override(m)
  local live = runner.getenv("FREETOPLAYGAMES_TEST_LIVE")
  local override = runner.getenv("FREETOPLAYGAMES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FREETOPLAYGAMES_TEST_EXPLAIN")
