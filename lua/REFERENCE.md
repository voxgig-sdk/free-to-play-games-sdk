# FreeToPlayGames Lua SDK Reference

Complete API reference for the FreeToPlayGames Lua SDK.
...
| `minimum_system_requirements` | `table` | No | Minimum system requirements for PC games |
...
| `screenshots` | `table` | No | Array of screenshot images |
