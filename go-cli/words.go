...
func registerSDKWords(r *eng.Registry, client *sdk.FreeToPlayGamesSDK) {
...
func runOp(client *sdk.FreeToPlayGamesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
