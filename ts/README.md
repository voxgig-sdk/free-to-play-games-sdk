# FreeToPlayGames TypeScript SDK



The TypeScript SDK for the FreeToPlayGames API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/free-to-play-games-sdk/releases](https://github.com/voxgig-sdk/free-to-play-games-sdk/releases)
...
```ts
import { FreeToPlayGamesSDK } from '@voxgig-sdk/free-to-play-games'
...
```ts
new FreeToPlayGamesSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `FreeToPlayGamesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `FreeToPlayGamesSDK.test(testopts?, sdkopts?)` | `FreeToPlayGamesSDK` | Create a test-mode client. |
...
| `client` | `client(): FreeToPlayGamesSDK` | Return the parent SDK client. |
...
| `minimum_system_requirements` | `Record<string, any>` | Minimum system requirements for PC games |
...
free-to-play-games/
├── src/
│   ├── FreeToPlayGamesSDK.ts        # Main SDK class
