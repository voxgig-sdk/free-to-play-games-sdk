...
// `class AdviceEntity extends FreeToPlayGamesEntityBase<Advice>`.
class FreeToPlayGamesEntityBase<D = any> {
  name = ''
  name_ = ''
  Name = ''

  _client: FreeToPlayGamesSDK
  _utility: Utility
  _entopts: any
  ...
  constructor(client: FreeToPlayGamesSDK, entopts: any) {
    entopts = entopts || {}
