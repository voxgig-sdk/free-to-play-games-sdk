...
// FreeToPlayGames SDK utility: fetcher

class FreeToPlayGamesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeToPlayGamesSDK/1.0)';
    ...
    public static function call(FreeToPlayGamesContext $ctx, string $fullurl, array $fetchdef): array
    {
