...
// FreeToPlayGames SDK telemetry feature
...
class FreeToPlayGamesTelemetryFeature extends FreeToPlayGamesBaseFeature
{
    ...
    private function _close(FreeToPlayGamesContext $ctx, bool $ok): void
    {
