...
// FreeToPlayGames SDK utility type

class FreeToPlayGamesUtility
{
    ...
    public static function copy(FreeToPlayGamesUtility $src): FreeToPlayGamesUtility
    {
        $u = new FreeToPlayGamesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
