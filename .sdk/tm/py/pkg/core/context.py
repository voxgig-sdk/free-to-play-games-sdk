...
from projectname_sdk.core.control import FreeToPlayGamesControl
...
class FreeToPlayGamesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FreeToPlayGamesControl()
        ...
        if isinstance(sp, FreeToPlayGamesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeToPlayGamesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeToPlayGamesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return FreeToPlayGamesOperation({})
    ...
    def make_error(self, code, msg):
        return FreeToPlayGamesError(code, msg, self)
