...
class FreeToPlayGamesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeToPlayGamesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FreeToPlayGamesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FreeToPlayGamesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
